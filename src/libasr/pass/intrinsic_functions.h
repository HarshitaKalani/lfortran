...
namespace Abs {
    ...
    static inline ASR::expr_t* instantiate_Abs(Allocator &al, const Location &loc,
        ...
        if (is_integer(*arg_types[0]) || is_real(*arg_types[0])) {
            ...
            ASR::expr_t *constant_two = b.f(2.0, real_type);
            ASR::expr_t *constant_point_five = b.f(0.5, real_type);
    ...
    static inline ASR::expr_t* instantiate_Sign(Allocator &al, const Location &loc,
        ...
        if (is_real(*arg_types[0])) {
            ...
            */
            ...
            body.push_back(al, b.If(b.iGtE(args[0], zero), {
                b.Assignment(result, args[0])
            }, /* else */  {
                b.Assignment(result, b.i32_neg(args[0], arg_types[0]))
            }));
            body.push_back(al, b.If(b.iLt(args[1], zero), {
...
namespace Dshiftl {
    ...
    static inline ASR::expr_t* instantiate_Dshiftl(Allocator &al, const Location &loc,
        ...
        */
        ASR::expr_t *thirty_two = b.i(32, return_type);
        ASR::expr_t *sixty_four = b.i(64, return_type);
...
namespace Bgt {
    ...
    static inline ASR::expr_t* instantiate_Bgt(Allocator &al, const Location &loc,
        ...
        body.push_back(al, b.If(b.Or(b.iGt(b.iMul(val1, val2), zero), b.And(b.iEq(b.iMul(val1, val2), zero), b.Or(b.iGt(val1, zero), b.iGt(val2, zero)))), {
            b.If(b.iGt(val1, val2), {
                b.Assignment(result, b.bool32(1))
            }, {})
        }, {
            b.If(b.iLt(val1, val2), {
                b.Assignment(result, b.bool32(1))
            }, {})
        }));
...
namespace Bge {
    ...
    static inline ASR::expr_t* instantiate_Bge(Allocator &al, const Location &loc,
        ...
        ASR::expr_t *val2 = args[1];
        body.push_back(al, b.If(b.Or(b.iGt(b.iMul(val1, val2), zero), b.And(b.iEq(b.iMul(val1, val2), zero), b.Or(b.iGt(val1, zero), b.iGt(val2, zero)))), {
            b.If(b.iGtE(val1, val2), {
                b.Assignment(result, b.bool32(1))
            }, {})
        }, {
            b.If(b.iLtE(val1, val2), {
                b.Assignment(result, b.bool32(1))
            }, {})
        }));
...
namespace Btest {
    ...
    static inline ASR::expr_t* instantiate_Btest(Allocator &al, const Location &loc,
        ...
        body.push_back(al, b.If(b.iEq(b.i_BitAnd(val1, b.i_BitLshift(one, val2, arg_types[0]), arg_types[0]), zero), {
...
namespace Floor {
    ...
    static inline ASR::expr_t* instantiate_Floor(Allocator &al, const Location &loc,
        ...
        */
        ...
        body.push_back(al, b.If(b.And(b.fLtE(args[0], b.f(0, arg_types[0])), b.fNotEq(cast1,cast2)), {
...
namespace SignFromValue {
    ...
    static inline ASR::expr_t* instantiate_SignFromValue(Allocator &al, const Location &loc,
        ...
        */
        if (is_real(*arg_types[0])) {
            ASR::expr_t *zero = b.f(0.0, arg_types[1]);
            body.push_back(al, b.If(b.fLt(args[1], zero), {
                b.Assignment(result, b.f32_neg(args[0], arg_types[0]))
            }, {
                b.Assignment(result, args[0])
            }));
        } else {
            ASR::expr_t *zero = b.i(0, arg_types[1]);
            body.push_back(al, b.If(b.iLt(args[1], zero), {
                b.Assignment(result, b.i32_neg(args[0], arg_types[0]))
            }, {
                b.Assignment(result, args[0])
...
namespace FlipSign {
    ...
    static inline ASR::expr_t* instantiate_FlipSign(Allocator &al, const Location &loc,
        ...
        */
        ...
        body.push_back(al, b.If(b.iEq(cond, b.i(1, arg_types[0])), {
...
namespace Maskl {
    ...
    static inline ASR::expr_t* instantiate_Maskl(Allocator &al, const Location &loc,
        ...
        */
        ...
        body.push_back(al, b.If((b.iEq(cast, sixty_four)), {b.Assignment(result, minus_one)},
...
namespace Trailz {
    ...
    static inline ASR::expr_t* instantiate_Trailz(Allocator &al, const Location &loc,
        ...
        */
        ...
        ASR::expr_t *cond = b.iEq(func_call_mod, b.i(0, arg_types[0]));
        ...
        ASR::expr_t* check_zero = b.iEq(args[0], b.i(0, arg_types[0]));
        std::vector<ASR::stmt_t*> if_body; if_body.push_back(b.Assignment(result, b.i(base, arg_types[0])));
...
namespace Leadz {
    ...
    static inline ASR::expr_t* instantiate_Leadz(Allocator &al, const Location &loc,
        ...
        */
        ...
        int arg_0_kind = ASRUtils::extract_kind_from_ttype_t(arg_types[0]);
        if ( arg_0_kind == 4 ) body.push_back(al, b.Assignment(total_bits, b.i(32, arg_types[0])));
        else body.push_back(al, b.Assignment(total_bits, b.i(64, arg_types[0])));
...
namespace SelectedRealKind {
    ...
    static inline ASR::expr_t* instantiate_SelectedRealKind(Allocator &al, const Location &loc,
        ...
        ASR::expr_t *cond1 = b.And(b.And(b.iLt(p, b.i(7, arg_types[0])), b.iLt(r, b.i(38, arg_types[1]))), b.iEq(radix, b.i(2, arg_types[2])));
        ASR::expr_t *cond2 = b.And(b.And(b.iLt(p, b.i(15, arg_types[0])), b.iLt(r, b.i(308, arg_types[1]))), b.iEq(radix, b.i(2, arg_types[2])));
        ASR::expr_t *cond3 = b.iNotEq(radix, b.i(2, arg_types[2]));
...
namespace SubstrIndex {
    ...
    static inline ASR::expr_t* instantiate_SubstrIndex(Allocator &al, const Location &loc,
        ...
        */
        ...
        ASR::expr_t* str_len = b.StringLen(args[0]);
        ASR::expr_t* sub_len = b.StringLen(args[1]);
        ASR::expr_t* string_section = b.StringSection(args[0], b.i_tSub(pos, b.i(1, return_type), return_type), pos);
        ASR::expr_t* substring_section = b.StringSection(args[1], b.i_tSub(j, b.i(1, return_type), return_type), j);       

        body.push_back(al, b.If(b.iLt(str_len, sub_len), {
            b.Assignment(found, b.bool32(0))
        }, {}));

        std::vector<ASR::stmt_t*> while_loop_body_inner;
        while_loop_body_inner.push_back(b.Assignment(pos, b.i_tAdd(i, k, return_type)));
        while_loop_body_inner.push_back(b.If(b.sNotEq(string_section, substring_section), {
            b.Assignment(found, b.bool32(0))
        }, {}));
        while_loop_body_inner.push_back(b.Assignment(j, b.i_tAdd(j, b.i(1, return_type), return_type)));
        while_loop_body_inner.push_back(b.Assignment(k, b.i_tAdd(k, b.i(1, return_type), return_type)));

        std::vector<ASR::stmt_t*> while_loop_body;
        while_loop_body.push_back(b.Assignment(k, b.i(0, return_type)));
        while_loop_body.push_back(b.Assignment(j, b.i(1, return_type)));
        while_loop_body.push_back(b.While(b.And(b.iLtE(j, sub_len), b.boolEq(found, b.bool32(1))), while_loop_body_inner));
        while_loop_body.push_back(b.If(b.boolEq(found, b.bool32(1)), {
            b.Assignment(idx, i),
            b.Assignment(found, args[2])
        }, {
            b.Assignment(found, b.bool32(1))
        }));
        while_loop_body.push_back(b.Assignment(i, b.i_tAdd(i, b.i(1, return_type), return_type)));
                
        body.push_back(al, b.While(b.And(b.iLt(i, str_len), b.boolEq(found, b.bool32(1))), while_loop_body));
